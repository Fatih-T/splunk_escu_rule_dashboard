...
PIPELINE_STAGES = [("new", "New"), ("under_review", "Under Review"), ("not_applicable", "Not Applicable"), ("applicable", "Applicable"), ("in_progress", "In Progress"), ("ready_for_cb", "Ready for CB"), ("converted", "Converted"), ("active", "Active"), ("tuning", "Tuning"), ("deprecated", "Deprecated")]
